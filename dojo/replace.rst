...
For ultimate flexibility you can use :ref:`dojo.replace` with a function as the second argument. The function is going to be called with 4 arguments:
...
Below are real-world examples of using :ref:`dojo.replace`.
