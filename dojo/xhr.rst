...
* :ref:`dojo.formToJson <dojo/formToJson>` : Convert a DOM Form to JSON.
* :ref:`dojo.formToObject <dojo/formToObject>` : Convert a DOM Form to a JavaScript object.
* :ref:`dojo.formToQuery <dojo/formToQuery>` : Convert a DOM Form to a query string.
* :ref:`dojo.objectToQuery <dojo/objectToQuery>` : Convert a JavaScript object to a query string.
* :ref:`dojo.queryToObject <dojo/queryToObject>` : Convert a query string to a JavaScript Object
