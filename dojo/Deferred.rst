...
The :ref:`dojo.when() <dojo/when>` function is also a useful tool for interacting with Deferred objects since it can provide normalization between asynchronous Deferreds and normal synchronous values.
