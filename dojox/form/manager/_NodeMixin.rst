...
This section describes all public methods and properties of :ref:`dojox.form.manager._NodeMixin` class.
...
These functions can register/unregister form nodes. In most cases these methods are not used directly because :ref:`dojox.form.manager._NodeMixin` registers all children form nodes automatically. But if you create/delete nodes dynamically, you should register/unregister them manually.
