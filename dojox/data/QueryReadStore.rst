...
.. cv-compound ::
  ...
  .. cv :: html 
    ...
    <div dojoType="dojox.data.QueryReadStore" url="{{ dataUrl }}/dojo/dojox/data/tests/stores/QueryReadStore.php" jsId="comboStore"></div>
...
.. cv-compound ::
  ...
  .. cv :: html 
    ...
    <div dojoType="dojox.data.QueryReadStore" url="{{ dataUrl }}/dojo/dojox/data/tests/stores/QueryReadStore.php" jsId="comboStore2"></div>
