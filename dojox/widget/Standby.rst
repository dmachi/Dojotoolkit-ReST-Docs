...
.. code-example ::
  ...
  .. css::
    ...
    <style type="text/css">
      @import "{{ dataUrl }}/dojo/dojox/widget/Standby/Standby.css";
    </style>  
...
.. cv-compound ::
  ...
  .. cv :: html 
    ...
    <div jsId="basicStandby4" dojoType="dojox.widget.Standby" target="basic4" color="lightgray" image="{{ dataUrl }}/dojo/dojox/widget/tests/images/busy.gif"></div>
